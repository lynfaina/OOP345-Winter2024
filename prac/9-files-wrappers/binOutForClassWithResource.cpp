...
int main() {
    ...
    // fstream file( "d_employee.bin", ios::out | ios::binary );
    // fstream name( "d_name.bin", ios::out | ios::binary );
    vector<Employee> E = { 
...
// d_employee.bin
// all binary stuff that we don't understand
// these are dumped into memory

// d_name.bin
// squeezed in one big thing
// no null termination
// length set automatically
